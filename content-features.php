...
?>
	...
	<article <?php post_class('fix'); ?>>
		...
		<?php if ( isset( $woo_options['woo_post_content'] ) && $woo_options['woo_post_content'] != 'content' && '' != $image_src ) { ?>
	    	<img src="<?php echo $image_src; ?>" alt="" class="feature-thumb <?php echo $settings['thumb_align']; ?>" />
	    <?php } ?>
